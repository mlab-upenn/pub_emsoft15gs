...
The complexity grows exponentially with the scale of the system, making it impossible to handle systems with more than a few variables. %, unless the simple periodic scheduling algorithm is used. 
%While simple and scalable, periodic schedules are static and limited in their capability to handle dynamics, safety constraints, and disturbances.
  ...
  The original system with binary control variables are approximated by an {\emph{averaged

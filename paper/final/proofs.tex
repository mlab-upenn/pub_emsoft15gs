...
%\label{sec:proof:averaged-sys-bound}
  ...
  % \]
  % where the last equality comes from the definition of $\eta_k$.
...
\paragraph*{Proof sketch of \protect\cref{thm:abstraction-gs:necessary-sufficient}}
...
\cref{thm:ex-simulation-relation} %, the definitions of the transition systems $T_{1}$ and $T_{2}$ (\cref{sec:abstraction-gs:feedback:Ts}), 
and all the constraints and dynamical equations %in and between

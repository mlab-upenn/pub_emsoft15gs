...
The contributions of this paper are \simplenote{TRUONG}:
\begin{enumerate}
\item scalable - averaged and abstract systems
\item Runtime suitable for embedded platforms
\item Case study showing scalability when MILP can go beyond 2D
\end{enumerate}

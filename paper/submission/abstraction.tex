...
hierarchical controller design (\simpletodo{ Cite George's papers on
verification, hierarchically consistent system, and
{\cite{girardetal07amd}}}).
...
\todo[inline]{The name ``extended simulation relation'' does not sound good. Perhaps we can use ``input-constrained simulation relation''?}


\begin{definition}[Extended Simulation]

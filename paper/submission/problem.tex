...
solvers.
In our simulation study (~\cref{sec:simulation}), with only two subsystems ($m=2$) and $N=288$, an 8-core MacPro with 64Gb RAM running the %state-of-the-art commercial
